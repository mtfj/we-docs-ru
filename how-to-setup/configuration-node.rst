...
.. warning:: Для нод версии 1.0.3 и выше в конфигурационном файле ноды в корневой секции ``vostok`` необходимо наличие следующего параметра:
