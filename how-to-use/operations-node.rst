...
1. Переведите все данные в кодировку **Base64**. Если данные хранятся в текстовом файле (``*.docx``, ``*.pdf``, ``*.txt`` и др.), переведите байтовую последовательность файла в кодировку **Base64**.
