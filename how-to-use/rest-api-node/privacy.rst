...
- policy - идентификатор политики, в рамках которой пересыалются данные;
...
Получение адресов всех участников, записанных в политику {policy}.
...
Получение полной информации по политике {policy}: участники, владельцы (пользователи, которые могут вносить изменения в policy), ссылки на транзакции добавления участников в policy.
