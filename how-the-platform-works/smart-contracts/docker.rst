...
Скачивание и исполнение Docker-контрактов, инициированных транзакциями с кодами ``103``, ``104``, ``105`` выполняется на нодах с включенной опцией ``docker-engine.enable = yes`` 
